  ...
  return (
    ...
    >
      <div className="grid grid-cols-4 items-center h-16 max-w-md mx-auto px-2">
        ...
        <button
          onClick={() => navigateTo('/')}
          className={`flex flex-col items-center justify-center min-h-[44px] min-w-[44px] transition-colors ${currentPath === '/' ? 'text-teal-800 font-semibold' : 'text-slate-500 hover:text-slate-800'}`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center min-h-[44px] min-w-[44px] transition-colors ${currentPath === '/panduan-layanan' ? 'text-teal-800 font-semibold' : 'text-slate-500 hover:text-slate-800'}`}
        >
          <svg className="w-5 h-5 mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center min-h-[44px] min-w-[44px] transition-colors ${currentPath === '/daftar-jadwal' ? 'text-teal-800 font-semibold' : 'text-slate-500 hover:text-slate-800'}`}
        >
          <svg className="w-5 h-5 mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center min-h-[44px] min-w-[44px] transition-colors ${currentPath === '/login-peserta' ? 'text-teal-800 font-semibold' : 'text-slate-500 hover:text-slate-800'}`}
        >
          <svg className="w-5 h-5 mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
